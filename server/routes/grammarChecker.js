...
grammarChecker.post("/", async (req, res) => {
  ...
  if (!sentence || sentence.trim() === "") {
    ...
    res.render("grammarCheck",{ correctedText, corrections,error:"" });
  } catch (error) {
    res.render("grammarCheck", { 
      error: error.message ,
      correctedText:'',
      corrections:[]
    });
